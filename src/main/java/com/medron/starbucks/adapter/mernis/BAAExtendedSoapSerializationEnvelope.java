...
class BAASoapFaultEx extends org.ksoap2.SoapFault
{
    public Object fault;
}
...
public class BAAExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(BAADateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new BAAStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static BAADateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static BAADateTimeConverter dateTimeConverter = new BAAStandardDateTimeConverter();

    public BAAExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public BAAExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new BAAMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=BAAHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,BAAExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=BAAHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
