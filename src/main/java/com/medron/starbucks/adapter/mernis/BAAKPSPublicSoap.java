...
public class BAAKPSPublicSoap
{
    ...
    public BAAKPSPublicSoap(){}

    public BAAKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public BAAKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        BAAExtendedSoapSerializationEnvelope envelope= new BAAExtendedSoapSerializationEnvelope(BAAExtendedSoapSerializationEnvelope.VER11);
